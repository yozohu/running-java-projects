...
public class AdjacencyListGraph<V,E> implements Graph<V,E> {
  ...
  public static void main(String[] args) {
  	...
  	AdjacencyListGraph trial = new AdjacencyListGraph();

  	trial.insertVertex('A');
  	trial.insertVertex('C');
  	trial.insertVertex('D');
  	trial.insertVertex('F');
  	trial.insertVertex('H');

  	//trial.insertEdge('A', 'H', 1);
